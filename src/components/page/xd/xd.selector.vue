                    ...
                    <el-card shadow="hover">
                        ...
                        <el-card shadow="hover">
                            <el-tabs v-model="activeName" @tab-click="onTabClick"  >
                                <el-tab-pane label="遥测" name="line"></el-tab-pane>
                                <el-tab-pane label="遥信" name="table"></el-tab-pane>
                            </el-tabs>
                        </el-card>
                        <el-card shadow="hover" style="margin-bottom: 0px;"    v-show="addtabs">
                            ...
                            <el-row style="margin-bottom: 0px;" v-for="(con,index) in conditionList" :key="index">
                        ...
                        <!--分页-->
                    <div class="block" style="float: right;margin-top: 5px;margin-bottom: 5px;">
                        ...
                        <!--table-->                        
                            ...
                            <el-table :data="viewtableData"     
                             ...
                             <!-- <el-table-column label="选择" width="50">
                                <template scope="scope">
                                    <el-radio :label="scope.$index" v-model="radio" class="textRadio"  @change.native="getCurrentRow(scope.$index)">&nbsp;</el-radio>
                                </template>
                            </el-table-column> 
                            -->
                             <!-- 添加一个多选框,控制选中与否 -->
                            ...
                            <el-table-column type="index" label="序号" width="50" v-if="false" ></el-table-column>
                            <!--  
                            <el-table-column  label="选择" v-if="addtabs"
                                type="selection"
                                width="55">
                            </el-table-column>  -->                          
    ...
    export default {
        data() {
            return {
                ...
                editableTabsValue: "0",
                editableTabs: ['SCADA_Analog','SCADA_Digit'],
                tabIndex: 0,
        ...
        methods: {
            ...
            onTabClick(tab) {                
                if ("line" === tab.name) {
                    this.tableName = this.editableTabs[0];
                }else
                {
                    this.tableName = this.editableTabs[1];
                }
...
//                                that.currentpage = 1;
            ...
            viewCloumns(begin,end){
                ...
                if(value.length<=0)
                {                   
                    value.push(columns[0].value);
                    value.push(columns[1].value);
                    value.push(columns[2].value);
                    value.push(columns[3].value);
                    value.push(columns[4].value);    
                    value.push(columns[5].value);    
                    value.push(columns[16].value);  
                }
